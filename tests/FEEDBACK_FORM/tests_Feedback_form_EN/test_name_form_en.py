...
def test_name_empty_fform_en(setup_en: Page) -> None:
    ...
    expect(setup_en.locator("//label[@for='firstName']/following-sibling::input")).to_have_attribute("class", "InputField_input__KEXwe InputField__error__hbnwz")
...
def test_name_2char_fform_en(setup_en: Page) -> None:
    ...
    setup_en.get_by_placeholder("email@gmail.com").click()
    expect(setup_en.locator("//label[@for='firstName']/following-sibling::input")).to_have_attribute("class", "InputField_input__KEXwe")
