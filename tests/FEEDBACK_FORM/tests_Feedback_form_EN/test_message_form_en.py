...
def test_message_empty_fform_en(setup_en: Page) -> None:
    ...
    expect(setup_en.locator("//textarea[@id='message']")).to_have_attribute("class", "TextArea_textarea__k_Krc TextArea__error__u8rOs")
...
def test_message_10char_fform_en(setup_en: Page) -> None:
    ...
    setup_en.get_by_placeholder("email@gmail.com").click()
    expect(setup_en.locator("//textarea[@id='message']")).to_have_attribute("class", "TextArea_textarea__k_Krc")
