...
def test_message_empty_fform_ua(setup: Page) -> None:
    ...
    expect(setup.locator("//textarea[@id='message']")).to_have_attribute("class", "TextArea_textarea__k_Krc TextArea__error__u8rOs")
...
def test_message_10char_fform_ua(setup: Page) -> None:
    ...
    setup.get_by_placeholder("email@gmail.com").click()
    expect(setup.locator("//textarea[@id='message']")).to_have_attribute("class", "TextArea_textarea__k_Krc")
