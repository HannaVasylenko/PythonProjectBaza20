...
def test_message_empty_fform_pl(setup_pl: Page) -> None:
    ...
    expect(setup_pl.locator("//textarea[@id='message']")).to_have_attribute("class", "TextArea_textarea__k_Krc TextArea__error__u8rOs")
...
def test_message_10char_fform_pl(setup_pl: Page) -> None:
    ...
    setup_pl.get_by_placeholder("email@gmail.com").click()
    expect(setup_pl.locator("//textarea[@id='message']")).to_have_attribute("class", "TextArea_textarea__k_Krc")
