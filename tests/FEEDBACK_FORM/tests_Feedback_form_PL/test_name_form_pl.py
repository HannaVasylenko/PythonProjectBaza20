...
def test_name_empty_fform_pl(setup_pl: Page) -> None:
    ...
    expect(setup_pl.locator("//label[@for='firstName']/following-sibling::input")).to_have_attribute("class", "InputField_input__KEXwe InputField__error__hbnwz")
...
def test_name_2char_fform_pl(setup_pl: Page) -> None:
    ...
    setup_pl.get_by_placeholder("email@gmail.com").click()
    expect(setup_pl.locator("//label[@for='firstName']/following-sibling::input")).to_have_attribute("class", "InputField_input__KEXwe")
