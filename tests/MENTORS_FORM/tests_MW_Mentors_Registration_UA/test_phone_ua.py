...
def test_phone_empty_mentor_ua(setup: Page) -> None:
    ...
    expect(setup.locator("//div[@class='RegistrationFormModal_wrapper__bgALB']//input[@id='phone']")).to_have_attribute("class", "InputField_input__KEXwe InputField__error__hbnwz")
...
def test_phone_valid_mentor_ua(setup: Page) -> None:
    ...
    setup.locator("//input[@id='discord']").click()
    expect(setup.locator("//div[@class='RegistrationFormModal_wrapper__bgALB']//input[@id='phone']")).to_have_attribute("class", "InputField_input__KEXwe")
