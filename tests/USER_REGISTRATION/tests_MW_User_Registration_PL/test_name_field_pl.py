...
def test_name_1_char_user_reg_pl(setup_pl: Page) -> None:
    ...
    expect(setup_pl.locator("//div[@class='RegistrationFormModal_wrapper__bgALB']//input[@id='firstName']")).to_have_attribute("class", "InputField_input__KEXwe InputField__error__hbnwz")
...
def test_name_2_char_user_reg_pl(setup_pl: Page) -> None:
    ...
    setup_pl.get_by_placeholder("Nazwisko").click()
    expect(setup_pl.locator("//div[@class='RegistrationFormModal_wrapper__bgALB']//input[@id='firstName']")).to_have_attribute("class", "InputField_input__KEXwe")
