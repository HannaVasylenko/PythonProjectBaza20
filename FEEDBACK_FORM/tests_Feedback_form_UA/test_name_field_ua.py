...
def test_name_empty_field_ua(setup: Page) -> None:
...
def test_name_space_field_ua(setup: Page) -> None:
...
def test_name_1char_field_ua(setup: Page) -> None:
...
def test_name_2char_field_ua(setup: Page) -> None:
...
def test_name_3char_field_ua(setup: Page) -> None:
    setup.get_by_placeholder("Ім’я").type("їєа")
    setup.get_by_placeholder("email@gmail.com").click()
    expect(setup.locator("//input[@id='firstName']")).to_have_attribute("class", "InputField_input___Wj0m")


def test_name_15char_field_ua(setup: Page) -> None:
    setup.get_by_placeholder("Ім’я").type("Шухевич Роман О")
    setup.get_by_placeholder("email@gmail.com").click()
    expect(setup.locator("//input[@id='firstName']")).to_have_attribute("class", "InputField_input___Wj0m")


def test_name_29char_field_ua(setup: Page) -> None:
    setup.get_by_placeholder("Ім’я").type("Степан Андрійович Бандера ОУН")
    setup.get_by_placeholder("email@gmail.com").click()
    expect(setup.locator("//input[@id='firstName']")).to_have_attribute("class", "InputField_input___Wj0m")


def test_name_30char_field_ua(setup: Page) -> None:
    setup.get_by_placeholder("Ім’я").type("степан андрійович бандераоун-б")
    setup.get_by_placeholder("email@gmail.com").click()
    expect(setup.locator("//input[@id='firstName']")).to_have_attribute("class", "InputField_input___Wj0m")


def test_name_31char_field_ua(setup: Page) -> None:
...
def test_name_50char_field_ua(setup: Page) -> None:
...
def test_name_apostrophe_field_ua(setup: Page) -> None:
    setup.get_by_placeholder("Ім’я").type("С'тепан'Андрійович'Бандера")
    setup.get_by_placeholder("email@gmail.com").click()
    expect(setup.locator("//input[@id='firstName']")).to_have_attribute("class", "InputField_input___Wj0m")


def test_name_hyphen_field_ua(setup: Page) -> None:
    setup.get_by_placeholder("Ім’я").type("С-тепан-Андрійович-Бандера")
    setup.get_by_placeholder("email@gmail.com").click()
    expect(setup.locator("//input[@id='firstName']")).to_have_attribute("class", "InputField_input___Wj0m")


def test_name_lowcase_field_ua(setup: Page) -> None:
    setup.get_by_placeholder("Ім’я").type("тестування")
    setup.get_by_placeholder("email@gmail.com").click()
    expect(setup.locator("//input[@id='firstName']")).to_have_attribute("class", "InputField_input___Wj0m")


def test_name_upcase_field_ua(setup: Page) -> None:
    setup.get_by_placeholder("Ім’я").type("ТЕСТУВАННЯ")
    setup.get_by_placeholder("email@gmail.com").click()
    expect(setup.locator("//input[@id='firstName']")).to_have_attribute("class", "InputField_input___Wj0m")


def test_name_num_field_ua(setup: Page) -> None:
...
def test_name_symb_field_ua(setup: Page) -> None:
...
def test_name_html_field_ua(setup: Page) -> None:
...
def test_name_latin_field_ua(setup: Page) -> None:
...
def test_name_piletters_field_ua(setup: Page, test_input) -> None:
