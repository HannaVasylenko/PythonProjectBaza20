...
def test_ff_mandatory_fields_en(setup_en: Page) -> None:
...
def test_ff_title_fields_en(setup_en: Page) -> None:
    expect(setup_en.locator("//section[@class='ContactFormSection_section__F3_Zu']//h2")).to_have_text("Feedback form")
    setup_en.get_by_role("heading", name="Feedback form").click()


def test_ff_active_sendbtn_fields_en(setup_en: Page) -> None:
...
def test_ff_hover_sendbtn_fields_en(setup_en: Page) -> None:
    setup_en.get_by_role("button", name="Send").hover()


def test_ff_default_sendbtn_fields_en(setup_en: Page) -> None:
    expect(setup_en.get_by_role("button", name="Send")).to_be_enabled()


def test_ff_disabled_sendbtn_fields_en(setup_en: Page) -> None:
...
def test_ff_send_form_fields_en(setup_en: Page) -> None:
...
def test_ff_placeholders_fields_en(setup_en: Page) -> None:
