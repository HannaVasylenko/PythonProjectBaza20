...
def test_message_empty_fieldf_en(setup_en: Page) -> None:
...
def test_message_space_fieldf_en(setup_en: Page) -> None:
...
def test_message_1char_fieldf_en(setup_en: Page) -> None:
...
def test_message_2char_fieldf_en(setup_en: Page) -> None:
...
def test_message_5char_fieldf_en(setup_en: Page) -> None:
...
def test_message_9char_fieldf_en(setup_en: Page) -> None:
...
def test_message_10char_fieldf_en(setup_en: Page) -> None:
...
def test_message_11char_fieldf_en(setup_en: Page) -> None:
    setup_en.get_by_placeholder("Your message").type("techniquese")
    setup_en.get_by_placeholder("email@gmail.com").click()
    expect(setup_en.locator("//textarea[@id='message']")).to_have_attribute("class", "InputField_input___Wj0m")


def test_message_150char_fieldf_en(setup_en: Page) -> None:
...
def test_message_299char_fieldf_en(setup_en: Page) -> None:
...
def test_message_300char_fieldf_en(setup_en: Page) -> None:
...
def test_message_301char_fieldf_en(setup_en: Page) -> None:
...
def test_message_upcase_fieldf_en(setup_en: Page) -> None:
    setup_en.get_by_placeholder("Your message").type("TESTINGTESTTEST")
    setup_en.get_by_placeholder("email@gmail.com").click()
    expect(setup_en.locator("//textarea[@id='message']")).to_have_attribute("class", "InputField_input___Wj0m")


def test_message_lowcase_fieldf_en(setup_en: Page) -> None:
    setup_en.get_by_placeholder("Your message").type("testingtesttest")
    setup_en.get_by_placeholder("email@gmail.com").click()
    expect(setup_en.locator("//textarea[@id='message']")).to_have_attribute("class", "InputField_input___Wj0m")


def test_message_symb_fieldf_en(setup_en: Page) -> None:
    setup_en.get_by_placeholder("Your message").type("Test design techniques !-_().,<>&?@$=+{}#*/[]\|?%^:;`₴’’””<>&?@$=+*\[/]?%;:")
    setup_en.get_by_placeholder("email@gmail.com").click()
    expect(setup_en.locator("//textarea[@id='message']")).to_have_attribute("class", "InputField_input___Wj0m")


def test_message_num_fieldf_en(setup_en: Page) -> None:
