...
def test_message_empty_fieldf_pl(setup_pl: Page) -> None:
...
def test_message_space_fieldf_pl(setup_pl: Page) -> None:
...
def test_message_1char_fieldf_pl(setup_pl: Page) -> None:
...
def test_message_2char_fieldf_pl(setup_pl: Page) -> None:
...
def test_message_5char_fieldf_pl(setup_pl: Page) -> None:
...
def test_message_9char_fieldf_pl(setup_pl: Page) -> None:
...
def test_message_10char_fieldf_pl(setup_pl: Page) -> None:
...
def test_message_11char_fieldf_pl(setup_pl: Page) -> None:
    setup_pl.get_by_placeholder("Twoja wiadomość").type("ężŚwęŁóżęża")
    setup_pl.get_by_placeholder("email@gmail.com").click()
    expect(setup_pl.locator("//textarea[@id='message']")).to_have_attribute("class", "InputField_input___Wj0m")


def test_message_150char_fieldf_pl(setup_pl: Page) -> None:
...
def test_message_299char_fieldf_pl(setup_pl: Page) -> None:
...
def test_message_300char_fieldf_pl(setup_pl: Page) -> None:
...
def test_message_301char_fieldf_pl(setup_pl: Page) -> None:
