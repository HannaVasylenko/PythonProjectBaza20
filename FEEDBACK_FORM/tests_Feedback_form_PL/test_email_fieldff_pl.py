...
def test_email_empty_fieldf_pl(setup_pl: Page) -> None:
...
def test_email_space_fieldf_pl(setup_pl: Page) -> None:
...
def test_email_сyrillic_in_namef_pl(setup_pl: Page) -> None:
...
def test_email_polski_in_namef_pl(setup_pl: Page) -> None:
...
def test_email_latin_in_namef_pl(setup_pl: Page) -> None:
    setup_pl.get_by_placeholder("email@gmail.com").type("test@gmail.com")
    setup_pl.get_by_placeholder("Twoja wiadomość").click()
    expect(setup_pl.locator("//input[@id='email']")).to_have_attribute("class", "InputField_input___Wj0m")


def test_email_1char_in_namef_pl(setup_pl: Page) -> None:
...
def test_email_70charf_pl(setup_pl: Page) -> None:
...
def test_email_num_in_namef_pl(setup_pl: Page) -> None:
    setup_pl.get_by_placeholder("email@gmail.com").type("vicky1792345680@gmail.com")
    setup_pl.get_by_placeholder("Twoja wiadomość").click()
    expect(setup_pl.locator("//input[@id='email']")).to_have_attribute("class", "InputField_input___Wj0m")


def test_email_up_case_in_namef_pl(setup_pl: Page) -> None:
    setup_pl.get_by_placeholder("email@gmail.com").type("TESTING@gmail.com")
    setup_pl.get_by_placeholder("Twoja wiadomość").click()
    expect(setup_pl.locator("//input[@id='email']")).to_have_attribute("class", "InputField_input___Wj0m")


def test_email_symb_in_namef_pl(setup_pl: Page) -> None:
...
def test_email_hyphen_in_namef_pl(setup_pl: Page) -> None:
    setup_pl.get_by_placeholder("email@gmail.com").type("T-est-design-techniques@gmail.com")
    setup_pl.get_by_placeholder("Twoja wiadomość").click()
    expect(setup_pl.locator("//input[@id='email']")).to_have_attribute("class", "InputField_input___Wj0m")


def test_email_underline_in_namef_pl(setup_pl: Page) -> None:
    setup_pl.get_by_placeholder("email@gmail.com").type("T_est_design_techniques@gmail.com")
    setup_pl.get_by_placeholder("Twoja wiadomość").click()
    expect(setup_pl.locator("//input[@id='email']")).to_have_attribute("class", "InputField_input___Wj0m")


def test_email_point_in_namef_pl(setup_pl: Page) -> None:
    setup_pl.get_by_placeholder("email@gmail.com").type("T.est.design.techniques@gmail.com")
    setup_pl.get_by_placeholder("Twoja wiadomość").click()
    expect(setup_pl.locator("//input[@id='email']")).to_have_attribute("class", "InputField_input___Wj0m")


def test_email_space_in_namef_pl(setup_pl: Page) -> None:
...
def test_email_without_first_domainf_pl(setup_pl: Page) -> None:
...
def test_email_without_namef_pl(setup_pl: Page) -> None:
...
def test_email_with_1char_in_first_domainf_pl(setup_pl: Page) -> None:
...
def test_email_with_2char_in_first_domainf_pl(setup_pl: Page) -> None:
    setup_pl.get_by_placeholder("email@gmail.com").type("test@gmail.co")
    setup_pl.get_by_placeholder("Twoja wiadomość").click()
    expect(setup_pl.locator("//input[@id='email']")).to_have_attribute("class", "InputField_input___Wj0m")


def test_email_without_dotf_pl(setup_pl: Page) -> None:
...
def test_email_incorrect_dotf_pl(setup_pl: Page) -> None:
    setup_pl.get_by_placeholder("email@gmail.com").type("@testgmail.com")
    setup_pl.get_by_placeholder("Twoja wiadomość").click()
    expect(setup_pl.locator("//input[@id='email']")).to_have_attribute("class", "InputField_input___Wj0m InputField__error__s2LFM")
    expect(setup_pl.locator("//label[@for='email']/../following-sibling::p")).to_have_text("Proszę podać poprawny adres e-mail")
...
def test_email_incorrect_dot2f_pl(setup_pl: Page) -> None:
    setup_pl.get_by_placeholder("email@gmail.com").type("testgmail.com@")
    setup_pl.get_by_placeholder("Twoja wiadomość").click()
    expect(setup_pl.locator("//input[@id='email']")).to_have_attribute("class", "InputField_input___Wj0m InputField__error__s2LFM")
    expect(setup_pl.locator("//label[@for='email']/../following-sibling::p")).to_have_text("Proszę podać poprawny adres e-mail")
...
def test_email_with_2_dotsf_pl(setup_pl: Page) -> None:
...
def test_email_with_ruf_pl(setup_pl: Page) -> None:
...
def test_email_with_byf_pl(setup_pl: Page) -> None:
