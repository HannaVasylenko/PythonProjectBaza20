...
def test_email_empty_en(setup_en: Page) -> None:
...
def test_email_space_en(setup_en: Page) -> None:
    setup_en.get_by_role("button", name="Become a mentor").click()
...
def test_email_сyrillic_in_name_en(setup_en: Page) -> None:
    setup_en.get_by_role("button", name="Become a mentor").click()
...
def test_email_latin_in_name_en(setup_en: Page) -> None:
    setup_en.get_by_role("button", name="Become a mentor").click()
...
def test_email_1char_in_name_en(setup_en: Page) -> None:
    setup_en.get_by_role("button", name="Become a mentor").click()
...
def test_email_2char_in_name_en(setup_en: Page) -> None:
    setup_en.get_by_role("button", name="Become a mentor").click()
...
def test_email_3char_in_name_en(setup_en: Page) -> None:
    setup_en.get_by_role("button", name="Become a mentor").click()
...
def test_email_35char_in_name_en(setup_en: Page) -> None:
    setup_en.get_by_role("button", name="Become a mentor").click()
...
def test_email_49char_in_name_en(setup_en: Page) -> None:
    setup_en.get_by_role("button", name="Become a mentor").click()
...
def test_email_50char_in_name_en(setup_en: Page) -> None:
    setup_en.get_by_role("button", name="Become a mentor").click()
...
def test_email_51char_in_name_en(setup_en: Page) -> None:
    setup_en.get_by_role("button", name="Become a mentor").click()
...
def test_email_70char_in_name_en(setup_en: Page) -> None:
    setup_en.get_by_role("button", name="Become a mentor").click()
...
def test_email_num_in_name_en(setup_en: Page) -> None:
    setup_en.get_by_role("button", name="Become a mentor").click()
...
def test_email_hyphen_in_name_en(setup_en: Page) -> None:
    setup_en.get_by_role("button", name="Become a mentor").click()
...
def test_email_underline_in_name_en(setup_en: Page) -> None:
    setup_en.get_by_role("button", name="Become a mentor").click()
...
def test_email_point_in_name_en(setup_en: Page) -> None:
    setup_en.get_by_role("button", name="Become a mentor").click()
    setup_en.get_by_role("textbox", name="email@gmail.com").type("t.est.design.techniques@gmail.com")
    setup_en.get_by_placeholder("+380 xx xxx xx xx").click()
    expect(setup_en.locator("//div[@class='RegistrationFormModal_wrapper__bgALB']//input[@id='email']")).to_have_attribute("class", "InputField_input___Wj0m")
...
def test_email_symb_in_name_en(setup_en: Page) -> None:
    setup_en.get_by_role("button", name="Become a mentor").click()
...
def test_email_space_in_name_en(setup_en: Page) -> None:
    setup_en.get_by_role("button", name="Become a mentor").click()
...
def test_email_without_first_domain_en(setup_en: Page) -> None:
    setup_en.get_by_role("button", name="Become a mentor").click()
...
def test_email_without_name_en(setup_en: Page) -> None:
    setup_en.get_by_role("button", name="Become a mentor").click()
...
def test_email_with_1char_in_first_domain_en(setup_en: Page) -> None:
    setup_en.get_by_role("button", name="Become a mentor").click()
...
def test_email_with_2char_in_first_domain_en(setup_en: Page) -> None:
    setup_en.get_by_role("button", name="Become a mentor").click()
...
def test_email_without_dot_en(setup_en: Page) -> None:
    setup_en.get_by_role("button", name="Become a mentor").click()
...
def test_email_incorrect_dot_en(setup_en: Page) -> None:
    setup_en.get_by_role("button", name="Become a mentor").click()
    setup_en.get_by_role("textbox", name="email@gmail.com").type("@anyagmail.com")
    setup_en.get_by_placeholder("+380 xx xxx xx xx").click()
    expect(setup_en.locator("//div[@class='RegistrationFormModal_wrapper__bgALB']//input[@id='email']")).to_have_attribute("class", "InputField_input___Wj0m InputField__error__s2LFM")
...
def test_email_incorrect_dot2_en(setup_en: Page) -> None:
    setup_en.get_by_role("button", name="Become a mentor").click()
    setup_en.get_by_role("textbox", name="email@gmail.com").type("anyagmail.com@")
    setup_en.get_by_placeholder("+380 xx xxx xx xx").click()
    expect(setup_en.locator("//div[@class='RegistrationFormModal_wrapper__bgALB']//input[@id='email']")).to_have_attribute("class", "InputField_input___Wj0m InputField__error__s2LFM")
...
def test_email_with_2_dots_en(setup_en: Page) -> None:
    setup_en.get_by_role("button", name="Become a mentor").click()
...
def test_email_with_lowcase_en(setup_en: Page) -> None:
    setup_en.get_by_role("button", name="Become a mentor").click()
...
def test_email_with_upcase_en(setup_en: Page) -> None:
    setup_en.get_by_role("button", name="Become a mentor").click()
    setup_en.get_by_role("textbox", name="email@gmail.com").type("TESTING@gmail.com")
    setup_en.get_by_placeholder("+380 xx xxx xx xx").click()
    expect(setup_en.locator("//div[@class='RegistrationFormModal_wrapper__bgALB']//input[@id='email']")).to_have_attribute("class", "InputField_input___Wj0m")
...
def test_email_with_ru_en(setup_en: Page) -> None:
    setup_en.get_by_role("button", name="Become a mentor").click()
...
def test_email_with_by_en(setup_en: Page) -> None:
    setup_en.get_by_role("button", name="Become a mentor").click()
