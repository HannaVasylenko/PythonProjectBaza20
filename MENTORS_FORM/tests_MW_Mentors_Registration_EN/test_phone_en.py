...
def test_phone_empty_en(setup_en: Page) -> None:
...
def test_phone_with_begin_en(setup_en: Page) -> None:
    setup_en.get_by_role("button", name="Become a mentor").click()
...
def test_phone_valid_en(setup_en: Page) -> None:
    setup_en.get_by_role("button", name="Become a mentor").click()
...
def test_phone_enter_num_en(setup_en: Page) -> None:
    setup_en.get_by_role("button", name="Become a mentor").click()
...
def test_phone_1char_en(setup_en: Page) -> None:
    setup_en.get_by_role("button", name="Become a mentor").click()
    setup_en.get_by_placeholder("+380 xx xxx xx xx").press("Control+A")
    setup_en.get_by_placeholder("+380 xx xxx xx xx").press("Delete")
...
def test_phone_2char_en(setup_en: Page) -> None:
    setup_en.get_by_role("button", name="Become a mentor").click()
    setup_en.get_by_placeholder("+380 xx xxx xx xx").press("Control+A")
    setup_en.get_by_placeholder("+380 xx xxx xx xx").press("Delete")
...
def test_phone_6char_en(setup_en: Page) -> None:
    setup_en.get_by_role("button", name="Become a mentor").click()
    setup_en.get_by_placeholder("+380 xx xxx xx xx").type("12")
    setup_en.locator("//input[@id='discord']").click()
    expect(setup_en.locator("//div[@class='RegistrationFormModal_wrapper__bgALB']//input[@id='phone']")).to_have_attribute("class", "InputField_input___Wj0m InputField__error__s2LFM")
...
def test_phone_12char_en(setup_en: Page) -> None:
    setup_en.get_by_role("button", name="Become a mentor").click()
...
def test_phone_13char_en(setup_en: Page) -> None:
    setup_en.get_by_role("button", name="Become a mentor").click()
    setup_en.get_by_placeholder("+380 xx xxx xx xx").type("999999999")
    setup_en.locator("//input[@id='discord']").click()
    expect(setup_en.locator("//div[@class='RegistrationFormModal_wrapper__bgALB']//input[@id='phone']")).to_have_attribute("class", "InputField_input___Wj0m")
...
def test_phone_14char_en(setup_en: Page) -> None:
    setup_en.get_by_role("button", name="Become a mentor").click()
...
def test_phone_20char_en(setup_en: Page) -> None:
    setup_en.get_by_role("button", name="Become a mentor").click()
...
def test_phone_сyrillic_en(setup_en: Page) -> None:
    setup_en.get_by_role("button", name="Become a mentor").click()
...
def test_phone_latin_en(setup_en: Page) -> None:
    setup_en.get_by_role("button", name="Become a mentor").click()
...
def test_phone_symb_en(setup_en: Page) -> None:
    setup_en.get_by_role("button", name="Become a mentor").click()
...
def test_phone_without_begin_en(setup_en: Page) -> None:
    setup_en.get_by_role("button", name="Become a mentor").click()
    setup_en.get_by_placeholder("+380 xx xxx xx xx").press("Control+A")
    setup_en.get_by_placeholder("+380 xx xxx xx xx").press("Delete")
