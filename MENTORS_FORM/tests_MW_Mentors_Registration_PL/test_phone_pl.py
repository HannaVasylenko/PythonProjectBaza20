...
def test_phone_empty_pl(setup_pl: Page) -> None:
...
def test_phone_with_begin_pl(setup_pl: Page) -> None:
    setup_pl.get_by_role("button", name="Zostać mentorem").click()
...
def test_phone_valid_pl(setup_pl: Page) -> None:
    setup_pl.get_by_role("button", name="Zostać mentorem").click()
...
def test_phone_enter_num_pl(setup_pl: Page) -> None:
    setup_pl.get_by_role("button", name="Zostać mentorem").click()
...
def test_phone_1char_pl(setup_pl: Page) -> None:
    setup_pl.get_by_role("button", name="Zostać mentorem").click()
    setup_pl.get_by_placeholder("+380 xx xxx xx xx").press("Control+A")
    setup_pl.get_by_placeholder("+380 xx xxx xx xx").press("Delete")
...
def test_phone_2char_pl(setup_pl: Page) -> None:
    setup_pl.get_by_role("button", name="Zostać mentorem").click()
    setup_pl.get_by_placeholder("+380 xx xxx xx xx").press("Control+A")
    setup_pl.get_by_placeholder("+380 xx xxx xx xx").press("Delete")
...
def test_phone_6char_pl(setup_pl: Page) -> None:
    setup_pl.get_by_role("button", name="Zostać mentorem").click()
    setup_pl.get_by_placeholder("+380 xx xxx xx xx").type("12")
    setup_pl.locator("//input[@id='discord']").click()
    expect(setup_pl.locator("//div[@class='RegistrationFormModal_wrapper__bgALB']//input[@id='phone']")).to_have_attribute("class", "InputField_input___Wj0m InputField__error__s2LFM")
...
def test_phone_12char_pl(setup_pl: Page) -> None:
    setup_pl.get_by_role("button", name="Zostać mentorem").click()
...
def test_phone_13char_pl(setup_pl: Page) -> None:
    setup_pl.get_by_role("button", name="Zostać mentorem").click()
    setup_pl.get_by_placeholder("+380 xx xxx xx xx").type("999999999")
    setup_pl.locator("//input[@id='discord']").click()
    expect(setup_pl.locator("//div[@class='RegistrationFormModal_wrapper__bgALB']//input[@id='phone']")).to_have_attribute("class", "InputField_input___Wj0m")
...
def test_phone_14char_pl(setup_pl: Page) -> None:
    setup_pl.get_by_role("button", name="Zostać mentorem").click()
...
def test_phone_20char_pl(setup_pl: Page) -> None:
    setup_pl.get_by_role("button", name="Zostać mentorem").click()
...
def test_phone_сyrillic_pl(setup_pl: Page) -> None:
    setup_pl.get_by_role("button", name="Zostać mentorem").click()
...
def test_phone_latin_pl(setup_pl: Page) -> None:
    setup_pl.get_by_role("button", name="Zostać mentorem").click()
...
def test_phone_polski_pl(setup_pl: Page) -> None:
    setup_pl.get_by_role("button", name="Zostać mentorem").click()
...
def test_phone_symb_pl(setup_pl: Page) -> None:
    setup_pl.get_by_role("button", name="Zostać mentorem").click()
...
def test_phone_without_begin_pl(setup_pl: Page) -> None:
    setup_pl.get_by_role("button", name="Zostać mentorem").click()
    setup_pl.get_by_placeholder("+380 xx xxx xx xx").press("Control+A")
    setup_pl.get_by_placeholder("+380 xx xxx xx xx").press("Delete")
