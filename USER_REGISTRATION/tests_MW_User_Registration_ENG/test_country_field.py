...
def test_countrypr_piletters_en(page: Page) -> None:
    page.goto("/")
    page.get_by_label("для зміни мови сторінки. вибрана мова").click()
    page.get_by_text("EN").click()
    page.get_by_role("banner").get_by_role("link", name="Internship").click()
    ...
    page.get_by_placeholder("Ukraine").press("Control+A")
    page.get_by_placeholder("Ukraine").press("Delete")
    page.get_by_placeholder("Ukraine").type("Пръерплрт")
    page.get_by_placeholder("Kyiv").click()
    expect(page.locator("//div[@class='RegistrationFormModal_wrapper__bgALB']//input[@id='country']")).to_have_attribute("class", "InputField_input___Wj0m InputField__error__s2LFM")
    expect(page.locator("//label[@for='country']/../following-sibling::p")).to_have_text("Enter the correct country name")
    page.screenshot(path="countrypren_screenshots/country1piletters.png")

    page.get_by_placeholder("Ukraine").press("Control+A")
    page.get_by_placeholder("Ukraine").press("Delete")
    page.get_by_placeholder("Ukraine").type("Орамыьтор")
    page.get_by_placeholder("Kyiv").click()
    expect(page.locator("//div[@class='RegistrationFormModal_wrapper__bgALB']//input[@id='country']")).to_have_attribute("class", "InputField_input___Wj0m InputField__error__s2LFM")
    expect(page.locator("//label[@for='country']/../following-sibling::p")).to_have_text("Enter the correct country name")
    page.screenshot(path="countrypren_screenshots/country2piletters.png")

    page.get_by_placeholder("Ukraine").press("Control+A")
    page.get_by_placeholder("Ukraine").press("Delete")
    page.get_by_placeholder("Ukraine").type("апмЭтиор")
    page.get_by_placeholder("Kyiv").click()
    expect(page.locator("//div[@class='RegistrationFormModal_wrapper__bgALB']//input[@id='country']")).to_have_attribute("class", "InputField_input___Wj0m InputField__error__s2LFM")
    expect(page.locator("//label[@for='country']/../following-sibling::p")).to_have_text("Enter the correct country name")
    page.screenshot(path="countrypren_screenshots/country3piletters.png")

    page.get_by_placeholder("Ukraine").press("Control+A")
    page.get_by_placeholder("Ukraine").press("Delete")
    page.get_by_placeholder("Ukraine").type("потлоЁьтбоа")
    page.get_by_placeholder("Kyiv").click()
    expect(page.locator("//div[@class='RegistrationFormModal_wrapper__bgALB']//input[@id='country']")).to_have_attribute("class", "InputField_input___Wj0m InputField__error__s2LFM")
    expect(page.locator("//label[@for='country']/../following-sibling::p")).to_have_text("Enter the correct country name")
    page.screenshot(path="countrypren_screenshots/country4piletters.png")

    page.get_by_placeholder("Ukraine").press("Control+A")
    page.get_by_placeholder("Ukraine").press("Delete")
    page.get_by_placeholder("Ukraine").type("Тиитрэтьтор")
    page.get_by_placeholder("Kyiv").click()
    expect(page.locator("//div[@class='RegistrationFormModal_wrapper__bgALB']//input[@id='country']")).to_have_attribute("class", "InputField_input___Wj0m InputField__error__s2LFM")
    expect(page.locator("//label[@for='country']/../following-sibling::p")).to_have_text("Enter the correct country name")
    page.screenshot(path="countrypren_screenshots/country5piletters.png")

    page.get_by_placeholder("Ukraine").press("Control+A")
    page.get_by_placeholder("Ukraine").press("Delete")
    page.get_by_placeholder("Ukraine").type("Иимпаётир")
    page.get_by_placeholder("Kyiv").click()
    expect(page.locator("//div[@class='RegistrationFormModal_wrapper__bgALB']//input[@id='country']")).to_have_attribute("class", "InputField_input___Wj0m InputField__error__s2LFM")
    expect(page.locator("//label[@for='country']/../following-sibling::p")).to_have_text("Enter the correct country name")
    page.screenshot(path="countrypren_screenshots/country6piletters.png")